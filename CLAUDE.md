...
6. **Наступне:** перевести сектор-рівневий `/insights` на той самий пайплайн
   (зараз єдина заглушка, що лишилася), або прибрати сторінку зовсім;
   плюс щотижневий Hangfire-job, що оновлює аналізи автоматично
7. Пізніше: CRUD транзакцій (buy/sell/dividend — сутність є, форм нема),
