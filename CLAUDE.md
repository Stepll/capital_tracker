...
19. **Наступне:** собівартість і P&L з транзакцій (дані вже лежать; метод — середня ціна,
   конвертація курсом на дату угоди); далі за потреби — пресети під брокерів,
   `windows-1251`; борг: мертвий `Sector`, невизначений `--text-muted`, неперевірена
   мобільна верстка, ротація бекапів
