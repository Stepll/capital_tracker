...
21. **Наступне:** результат на рівні портфеля (потребує валюти відображення); за потреби —
   пресети під брокерів, `windows-1251`; борг: мертвий `Sector`, невизначений
   `--text-muted`, ротація бекапів
